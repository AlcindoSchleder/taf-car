...
class CarriersProducts(models.Model):
    ...
    qtdembalagem = models.DecimalField(max_digits=5, decimal_places=2, verbose_name='Qtd. Embalagem')
    qtdatual = models.DecimalField(max_digits=5, decimal_places=2, verbose_name='Qtd. Atual')
    ...
    mcubtotal = models.DecimalField(max_digits=9, decimal_places=2, verbose_name='Cubagem')
    pesototal = models.DecimalField(max_digits=9, decimal_places=2, verbose_name='Peso')
    ...
    valorcarga = models.DecimalField(max_digits=11, decimal_places=2, verbose_name='Valor da Carga')
    qtdembcargasep = models.DecimalField(max_digits=9, decimal_places=2, verbose_name='Qtd. Emb. Separ.')
    qtdcontada = models.DecimalField(max_digits=9, decimal_places=2, verbose_name='Qtd. Emb. Contada')
    qtdembsolcargasep = models.DecimalField(max_digits=9, decimal_places=2, verbose_name='Qtd. Emb. Carga Solic.')
    qtdembsepcargasep = models.DecimalField(max_digits=9, decimal_places=2, verbose_name='Qtd. Emb. Carga Separ.')
    ...
    peso = models.DecimalField(max_digits=9, decimal_places=2, verbose_name='Peso.')
    metragemcubica = models.DecimalField(max_digits=9, decimal_places=2, verbose_name='Cubagem')
    ...
    pesototallote = models.DecimalField(max_digits=9, decimal_places=2, verbose_name='Peso Lote')
    mcubtotallote = models.DecimalField(max_digits=9, decimal_places=2, verbose_name='Cubagem Lote')
    qtdvolumelote = models.DecimalField(max_digits=9, decimal_places=2, verbose_name='Valumes Lote')
    qtditemlote = models.DecimalField(max_digits=9, decimal_places=2, verbose_name='Items do Lote')
    ...
    qtdembsolcarga = models.DecimalField(max_digits=9, decimal_places=2, verbose_name='Qtd. Emb. Solic.')
